...
public class UserControllerTest {
    ...
    public void test1() throws Exception {
        ...
        mockMvc.perform(get("/user/{id}", 1)) //执行请求
                ...
                .andExpect(model().attribute("user", hasProperty("name", equalTo("wuhaixu")))) //验证存储模型数据
    ...
    public void test4() throws Exception {
        //验证请求参数绑定
        mockMvc.perform(post("/user").param("name", "wuhaixu")) //执行传递参数的POST请求(也可以post("/user?name=wuhaixu"))
    ...
    public void test7() throws Exception {
        //JSON请求/响应
        String requestBody = "{\"id\":1, \"name\":\"wuhaixu\"}";
        ...
        String errorBody = "{id:1, name:wuhaixu}";
    ...
    public void test8() throws Exception {
        //XML请求/响应
        String requestBody = "<user><id>1</id><name>wuhaixu</name></user>";
        mockMvc.perform(post("/user")
        ...
        String errorBody = "<user><id>1</id><name>wuhaixu</name>";
        MvcResult result = mockMvc.perform(post("/user")
    ...
    public void test11() throws Exception {
        ...
        //Callable
        MvcResult result = mockMvc.perform(get("/user/async1?id=1&name=wuhaixu")) //执行请求
        ...
        //DeferredResult
        result = mockMvc.perform(get("/user/async2?id=1&name=wuhaixu")) //执行请求
                .andExpect(request().asyncStarted())
                .andExpect(request().asyncResult(CoreMatchers.instanceOf(User.class)))  //默认会等10秒超时
                .andReturn();
